...
//        public static final String BASE_URL="http://192.168.56.1:80/retrofit_test/";
        ...
        public static Retrofit getApiClient(){
            //Api less than 20 Internet SSL connection stuff
...
//                        .sslSocketFactory(new Tls12SocketFactory(new Tls12SocketFactory(sc.getSocketFactory())))
...
//                retrofit =new Retrofit.Builder().client(client).baseUrl(BASE_URL).addConverterFactory(ScalarsConverterFactory.create()).build();
